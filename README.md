...
> **[To Do App]** is a web application  built by react and whose user interface as a bunch of encapsulated, isolated, and reusable code components merged to create a complex user interface. It utilizes most React functionality and best practise. 
...
- Use the following Commands:
      ...
      git clone git@github.com:ProgramKingAbel/react-todo-app.git
...
- [ ] **[Add more functionality/Content to the Site]**
...
Feel free to check the [issues page](https://github.com/ProgramKingAbel/react-todo-app/issues).
